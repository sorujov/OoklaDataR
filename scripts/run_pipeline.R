# =============================================================================
# OoklaDataR - Master Pipeline Script
# =============================================================================
...
cat("  - This will download and process data for 26 quarters (2019-2025)\n")
cat("  - Each quarter: ~200-500 MB download\n")
cat("  - Total download: ~5-13 GB (temporary)\n")
cat("  - Final storage: < 5 GB (after cleanup)\n")
cat("  - Processing time: 2-6 hours depending on internet speed\n")
cat("  - Raw files are auto-deleted after processing to save space\n\n")

# Ask for confirmation
cat("Do you want to continue? (yes/no): ")
...
cat("  GitHub: https://github.com/sorujov/OoklaDataR\n\n")
